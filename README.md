...
macOS 13/AppKit and Linux/GTK 4 are currently supported. GTK 3 is not supported due to issues with horizontal scroll views, and UIKit and Android are experimental due to issues with NavigationSplitView. Windows is untested.
